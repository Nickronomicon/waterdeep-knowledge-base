...
Davy is a level 3 human Phantom rogue with a noble background. The sheet presents him as a stealth and sleight-of-hand specialist with spectral rogue features, practical tools, and a very young noble profile.
...
|---:|---:|---:|---:|---:|---:|
| 10 (+0) | 15 (+2) | 14 (+2) | 11 (+0) | 13 (+1) | 12 (+1) |

## Proficiencies

- Saving throws: Dexterity, Intelligence.
- Expertise: Sleight of Hand +6, Stealth +6.
- Other notable skills: Acrobatics +4, Perception +3, Persuasion +3, Deception +3, Athletics +2, History +2, Investigation +2.
- Tools: carpenter's tools, dragonchess set, forgery kit, thieves' tools.
- Languages: Chondathan, Common, Common Sign Language, Thieves' Cant.
- Armor and weapons: light armor; simple weapons, hand crossbow, rapier, scimitar, shortsword, whip.

## Combat Profile

- Light crossbow: +4, 1d8+2 piercing.
- Dagger: +4, 1d4+2 piercing.
- Sneak Attack: 2d6 once per turn when conditions are met.
- Cunning Action: Dash, Disengage, or Hide as a bonus action.
- Steady Aim for advantage when Davy does not move.
- Phantom rogue features: Whispers of the Dead and Wails from the Grave, 2 uses per long rest.
- Alert feat and Weapon Mastery options listed for dagger and hand crossbow.

## Equipment and Money

- 58 gp.
- Leather armor, two daggers, light crossbow, bolts.
- Thieves' tools, oil, ball bearings, rope, crowbar, bell, tinderbox, hooded lantern, rations, waterskin.

## Character Notes From Sheet

- Male, age 16, Medium, 5 ft. 8 in., 115 lb.
...
- Was contacted by [[People/NPCs/Vajra Safahr]] by Sending about the cargo receipt lead and responsibly relayed the information to the party.
- Gave the urchins one of his daggers for emergency defense if the floating eye returned, while refusing to hand over heavier weapons.
- Cleaned up for the opera, waited for [[People/NPCs/Threestrings]], and received a very loud formal outfit plus a good black felt hat.
...
- Continued as the party member most directly connected to Dorgar's seance preparations.
- Shot a giant rat with a crossbow during the Trollskull cellar fight and later stabbed at rat swarms in close quarters.
- Forced open the hidden sewer-side door in the smuggler's passage with thieves' tools.
- Helped Dorgar with the seance as his apprentice.
- Served as the primary questioner once Lif appeared.
