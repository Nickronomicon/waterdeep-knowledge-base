...
Jonathan Usman Sonny Theodore Icarus Charles Eagleshield, sometimes abbreviated JUSTICE, is a level 3 aasimar Oath of Devotion paladin with a noble background. He is the party's heavily armored moral front line, built around devotion, radiant/celestial features, healing, and direct confrontation.
...
|---:|---:|---:|---:|---:|---:|
| 14 (+2) | 9 (-1) | 15 (+2) | 8 (-1) | 9 (-1) | 15 (+2) |

## Proficiencies

- Saving throws: Wisdom, Charisma.
- Notable skills: Athletics +4, Intimidation +4, Persuasion +4, History +1.
- Tools: playing card set.
- Languages: Common, Draconic, Elvish.
- Armor and weapons: heavy armor, medium armor, light armor, shields, simple weapons, martial weapons.

## Combat Profile

- Greatsword: +4, 2d6+2 slashing, Graze mastery.
- Morningstar mastery: Sap.
- Lay on Hands pool: 15 per long rest.
- Paladin's Smite: Divine Smite is always prepared and can be cast once per long rest without a spell slot.
- Channel Divinity: 2 uses per long rest, with one expended use recoverable after a short rest.
- Oath of Devotion: Sacred Weapon.
- Aasimar traits: darkvision, Healing Hands, Light Bearer, Celestial Revelation, radiant/necrotic resistance.
...
1st-level spells and always-prepared spells:
...
- 25 gp.
- Shield, chain mail, greatsword, morningstar.
- Amulet, robe, blanket, lamp, holy water, rations, tinderbox.
