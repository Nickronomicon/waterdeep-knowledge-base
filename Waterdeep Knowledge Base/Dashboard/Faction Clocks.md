...
- 0/6: dormant or only background context.
- 1-2/6: present but not urgent.
- 3-4/6: active pressure; consequences should appear soon.
- 5/6: immediate complication waiting for a trigger.
- 6/6: trigger the listed consequence and reset or replace the clock.

For 8-step clocks, use the same logic with a little more room for the Grand Game factions.
