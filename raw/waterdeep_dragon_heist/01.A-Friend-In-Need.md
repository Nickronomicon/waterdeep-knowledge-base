...
![](./images/02-001.friend-in-need.png)
...
The human combatants are five members of the Xanathar Guild (CE human [bandits](https://www.dndbeyond.com/monsters/16798-bandit)). The one with the eye-shaped tattoos on his bald pate is their leader, Krentz. Their foe, [Yagra Strongfist](https://www.dndbeyond.com/monsters/17035-thug), is a half-orc employed by the Zhentarim (see the Yawning Portal Friendly Faces handout in [appendix C](./Handouts.md#yawning-portal-friendly-faces "appendix C")). Yagra fights for her pride.
...
Remember how the characters deal with Krentz in this scene. If he survives, the characters might meet him again in one of the Xanathar Guild’s sewer hideouts (see [area Q5](#q5-sleeping-area)).

#### Hanging Back

If the characters don’t interfere in the brawl, Yagra knocks Krentz out cold but is then beaten [unconscious](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#UnconsciousCondition) by his companions. Durnan, the proprietor of the Yawning Portal, points toward the door. “Out!” he snarls, and the Xanathar Guild members flee carrying Krentz’s [unconscious](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#UnconsciousCondition) form.
...
The [troll](https://www.dndbeyond.com/monsters/17040-troll), which currently has 44 hit points, has crawled up from the first level of Undermountain to feed on tasty humanoid flesh, bringing nine [stirges](https://www.dndbeyond.com/monsters/17023-stirge) with it. Once in the taproom, the troll rises to its full height of 9 feet and rolls initiative. The stirges also roll initiative, but only the three flying above the troll pose a threat. The remaining stirges are bloated, having drained copious amounts of the troll’s blood, and fly back down the shaft to digest their meal. As the troll regenerates, the effects of its blood loss become less apparent.

Most tavern patrons and staffers flee or take cover at the sight of the troll. The stirges attack the nearest characters as [Durnan](https://www.dndbeyond.com/monsters/149798-durnan) (see [appendix B](./Monsters-and-NPCs.md#durnan)) draws his great­sword, springs over the bar, and confronts the monster himself. As he attacks, he calls on the characters to focus on slaying the stirges and then douse the troll with lamp oil and set it on fire when it falls. Yagra joins the fight if she’s conscious. To any characters who help defeat the troll, Durnan says matter-of-factly, “You fought well.”
...
Volo gives each character a small pouch containing 10 gp simply for accepting his quest. Characters who want to discover his intentions must make a DC 10 Wisdom ([Insight](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#Skills)) check. On a success, a character discerns that Volo is honest but might be stretching the truth about how much he can pay. (Currently low on cash, Volo is awaiting royalty payments from [*Volo’s Guide to Monsters*](https://www.dndbeyond.com/compendium/rules/vgtm "Volo’s Guide to Monsters"). To make more coin, he began work on a new book, Volo’s Guide to Spirits and Specters. As it happens, his knowledge of spirits mostly concerns the alcoholic variety, and the writing has not been going well.) If pressed, Volo urges the characters to trust him, and promises he’ll have the rest of the reward, 100 gp per character, ready to deliver once Floon is returned to him alive.
...
Unbeknownst to Volo, not long after he departed, a drunken Floon met another acquaintance, Lord Renaer Neverember, at the tavern. The two left together, with Renaer offering to walk Floon home. Five Zhentarim thugs working for Urstul Floxin (see [appendix B](./Monsters-and-NPCs.md#urstul-floxin)) jumped both Floon and Renaer. They took them to a warehouse in the Dock Ward, so they could question Renaer — the son of Lord Dagult Neverember — about the whereabouts of the [Stone of Golorr](https://www.dndbeyond.com/magic-items/254348-stone-of-golorr) and his father’s hidden cache of dragons. Before the interrogation could begin, members of the Xanathar Guild ambushed and killed the Zhent guards in the warehouse. The new arrivals mistook Floon for Renaer, knocked Floon [unconscious](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#UnconsciousCondition), and dragged him away while Renaer hid and escaped their notice.
...
En route to the tavern, “[Blood in the Streets](#blood-in-the-streets)” is a chance for characters to see the City Watch in action. If the characters decide to look around, “[Searching the Dock Ward](#searching-the-dock-ward)” gives them a feel for their surroundings, and they might discover a strange place, “[Old Xoblob Shop](#old-xoblob-shop),” that warrants further exploration. Once they arrive at their destination, “[The Skewered Dragon](#the-skewered-dragon)” is an opportunity for the characters to get information from the patrons, which leads them to “[Candle Lane](#candle-lane),” where their quest continues.
...
The skirmish that occurred here has nothing to do with Floon’s disappearance but represents an escalation in the conflict between the Zhentarim and the Xanathar Guild. A dozen [guards](https://www.dndbeyond.com/monsters/16915-guard) of the City Watch have arrested three [bandits](https://www.dndbeyond.com/monsters/16798-bandit) and are questioning witnesses while waiting for wagons to take away the criminals and the corpses. The survivors of the skirmish have been stripped of their weapons and forced to kneel with their hands on their heads. All three, loyal Zhentarim agents (employed by Urstul Floxin; see [appendix B](./Monsters-and-NPCs.md#urstul-floxin)), are likely to be accused of murder. They coldly catch the eye of anyone who passes by, but the City Watch won’t let the characters anywhere near the prisoners.
...
If the characters check out the shop, continue with “[Old Xoblob Shop](#old-xoblob-shop).” If they don’t, they find the tavern without further incident; see “[The Skewered Dragon](#the-skewered-dragon)” below.
...
Floon has not been at the Skewered Dragon since the night of his disappearance, and the dive’s dockworker patrons are loath to talk to strangers. A bribe or a successful DC 13 Charisma ([Intimidation](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#Skills) or [Persuasion](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#Skills)) check gets them to open up.
...
When the characters try to enter, determine if the four [kenku](https://www.dndbeyond.com/monsters/17165-kenku) inside are aware of their presence before reading the boxed text.
...
The kenku fight until two of them are [incapacitated](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#IncapacitatedCondition) or killed, whereupon the survivors try to flee. A successful DC 10 Charisma ([Intimidation](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#Skills)) check forces captured kenku to divulge what they know.
...
The door to this back room hangs loosely on broken hinges. The cramped chamber beyond smells strongly of sour fish and vinegar. It is filled with discarded ropes, canvas tarpaulins, and splintered wood from smashed barrels. Renaer Neverember (see [appendix B](./Monsters-and-NPCs.md#renaer-neverember)) is hiding here, having slipped free of his rope bonds. The characters can hear his ragged breathing coming from under a tarpaulin at the north end of the room.
...
The upper floor contains a suite of offices that get little use by the Zhents. The rooms have desks, chairs, and bare shelves covered with dust and draped in cobwebs. Harmless [rats](https://www.dndbeyond.com/monsters/16991-rat) skitter about.

Mounted above each office door is a steel alarm bell. The bells are connected by wires to the secret door in [area Z3](#z3-secret-room), and they ring loudly when that door is opened.

#### Treasure

A character who searches the offices finds an unused [paper bird](https://www.dndbeyond.com/magic-items/254337-paper-bird) (see [appendix A](./Magic-Items.md#paper-bird)).

## The Watch Arrives

Shortly after the characters find Renaer, a captain of the City Watch named Hyustus Staget (LG male Illuskan human [veteran](https://www.dndbeyond.com/monsters/17045-veteran)) leads a dozen [veterans](https://www.dndbeyond.com/monsters/17045-veteran) to the warehouse. Having received a report of suspicious activity, they barge in and try to prevent anyone from leaving. Kenku that are still alive and present are taken into custody, and it doesn’t take long for the City Watch to conclude that the dead men are members of the Zhentarim and the Xanathar Guild, since violent encounters between the two factions are becoming ever more frequent. While his constables search the warehouse, Captain Staget questions the characters.
...
At this point, the characters likely know that Floon was kidnapped by Xanathar Guild members who mistook him for Renaer Neverember, and that he was taken to a hideout in the sewers. If the characters didn’t learn from the kenku where Floon was taken, asking questions of the locals can reveal that many people saw him being dragged off. A successful DC 15 Intelligence ([Investigation](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#Skills)) check or 5 gp in bribes allows the characters to trace the kidnappers’ path through back alleys to a circular metal cover inset in the pavement. The cover is easily lifted, revealing a ladder down into the sewers.

### Navigating the Sewers

The sewers have no natural light. Characters without [darkvision](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#Darkvision) need light sources to see.
...
A hostile [gazer](https://www.dndbeyond.com/monsters/17221-gazer) (see [appendix B](./Monsters-and-NPCs.md#gazer)) that is in league with [Grum’shar](https://www.dndbeyond.com/monsters/280299-grumshar), the local Xanathar Guild boss, guards this intersection. Once the characters defeat it, they can press on, following the corridor where the chalk symbol is located; they reach the hideout after following the correct tunnel for 5 minutes.
...
The boss of this hideout is a half-orc named [Grum’shar](https://www.dndbeyond.com/monsters/280299-grumshar). When the characters arrive, Grum’shar is interrogating Floon Blagmaar in [area Q7](#q7-boss-fight). His display of torture techniques is a ploy to impress his other guest: a mind flayer named Nihiloor (see [appendix B](./Monsters-and-NPCs.md#nihiloor)).
...
![](./images/map-02.02-xanathar-hideout.png)

[View Player Version](./images/map-02.02-xanathar-hideout-player.jpg "View Player Version")
...
A secret door in the wall of the tunnel that leads south can be found with a successful DC 15 Wisdom ([Perception](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#Skills)) check.

### Q2. Watch Posts

Two [goblins](https://www.dndbeyond.com/monsters/16907-goblin) are stationed here, one in area Q2a and one in Q2b. Allies of the Xanathar Guild, they came here from Undermountain. The goblins rely on [darkvision](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#Darkvision) to see and are supposed to be watching area Q1, but both have dozed off. Characters who succeed on a DC 9 Dexterity ([Stealth](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#Skills)) check can sneak past the sleeping goblins without waking them.
...
This room contains six tattered, straw-stuffed mattresses and nothing of value. If the occupant or occupants of [area Q5](#q5-sleeping-area) have not been dealt with already, the characters hear the sounds of activity in that room through the thin wooden door that separates these two chambers.

### Q5. Sleeping Area

This room contains six tattered, straw-stuffed mattresses and a hostile member of the Xanathar Guild, a [duergar](https://www.dndbeyond.com/monsters/16850-duergar) named Zemk. If Krentz (CE human [bandit](https://www.dndbeyond.com/monsters/16798-bandit)) escaped from the Yawning Portal after the tavern brawl that kicked off the adventure, he’s here as well.

When the characters arrive, Zemk is using pieces of furniture to barricade the door to [area Q6](#q6-lavatory). If Krentz is here, he’s trying to explain that Zemk’s approach won’t work, and is telling him to plug the gap at the bottom of the door with blankets. Neither of them notices intruders right away unless the interlopers make a lot of noise.
...
Neither Zemk nor Krentz carries any treasure. Both report to Grum’shar (see [area Q7](#q7-boss-fight)).

### Q6. Lavatory

This room has a hole in the floor that opens into a cesspit. A [gray ooze](https://www.dndbeyond.com/monsters/16909-gray-ooze) has emerged from the pit and killed two goblins that were sent into the room to dispose of it. The goblins’ bones float amid the ooze’s gooey form, and their pitted weapons lie on the floor nearby. None of the gear is salvageable.
...
The tentacled creature is Nihiloor (see [appendix B](./Monsters-and-NPCs.md#nihiloor)), a [mind flayer](https://www.dndbeyond.com/monsters/17104-mind-flayer) that is caressing an [intellect devourer](https://www.dndbeyond.com/monsters/17163-intellect-devourer). Upon seeing the adventurers, Nihiloor rises from the stone chair, sets its pet down, and glides across the room, intending to leave through the double door in the west wall. The mind flayer expects Grum’shar and the intellect devourer to cover its escape.

Nihiloor carries a 3-inch-diameter stone orb carved to resemble an eyeball, similar to what one might see at the end of a beholder’s eyestalk. This stone eye is the key to activating the magic portal in [area Q11](#q11-back-door). The mind flayer uses it to return to Xanathar’s lair (described in [chapter 5](./05.Spring-Madness.md#xanathars-lair "chapter 5")). It uses [dominate monster](https://www.dndbeyond.com/spells/2077-dominate-monster) to control someone who gets in its way and turns any such individuals against their allies.

The half-orc is [Grum’shar](https://www.dndbeyond.com/monsters/280299-grumshar), a low-end Xanathar Guild boss. As soon as his minions retrieved who they thought was Renaer Neverember, the half-orc begged Nihiloor let him witness the interrogation of the captive, not realizing until after he did so that he had mistaken the prisoner’s identity. Grum’shar attacks the characters in the hope of salvaging his reputation. He is an [apprentice wizard](https://www.dndbeyond.com/monsters/17325-apprentice-wizard) (see [appendix B](./Monsters-and-NPCs.md#apprentice-wizard)), with these changes:

*   Grum’shar is chaotic evil.
*   He has these racial traits: When reduced to 0 hit points, he drops to 1 hit point instead (but can’t do this again until he finishes a long rest). He has [darkvision](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#Darkvision) out to a range of 60 feet. He speaks Common and Orc.

#### Roleplaying Floon

As a result of Grum’shar’s torture, Floon Blagmaar (see [appendix B](./Monsters-and-NPCs.md#floon-blagmaar)) has 1 hit point left. If he is healed by the characters, he is eternally grateful and shows his affection by hugging them. He stays close to them, trusting in their ability to protect him. If Renaer is with the party, he can shoulder the burden of protecting Floon.

#### Treasure

In a satchel, Grum’shar carries his spellbook, which contains the following spells: [burning hands](https://www.dndbeyond.com/spells/2021-burning-hands), [disguise self](https://www.dndbeyond.com/spells/2069-disguise-self), [false life](https://www.dndbeyond.com/spells/2093-false-life), [shield](https://www.dndbeyond.com/spells/2247-shield), [unseen servant](https://www.dndbeyond.com/spells/2288-unseen-servant), and [witch bolt](https://www.dndbeyond.com/spells/2323-witch-bolt).

Tucked behind the stone chair is a small, unlocked wooden chest containing two [potions of healing](https://www.dndbeyond.com/magic-items/8960641-potion-of-healing), 16 gp, 82 sp, and 250 cp.

### Q8. Getaway Passage

This room looks empty, but a thorough search accompanied by a successful DC 10 Wisdom ([Perception](https://www.dndbeyond.com/sources/dnd/free-rules/playing-the-game#Skills)) check reveals a rough-hewn tunnel hidden beneath a loose flagstone. The low tunnel leads north to [area Q9](#q9-private-cellar).
...
If the stone eye in Nihiloor’s possession is pressed into the circular indentation, an opaque black doorway magically opens in the south wall. The opening is 8 feet tall and 4 feet wide. Any creature that passes through it appears in [area X22](./05.Spring-Madness.md#x22-arrival-point) of Xanathar’s lair (see [chapter 5](./05.Spring-Madness.md#xanathars-lair "chapter 5")). The door is a one-way portal, and it closes again 1 minute after the stone eye is removed from the pillar.
...
[Roscoe Underbough](https://www.dndbeyond.com/monsters/280305-roscoe-underbough), a Shard Shunner in hybrid form, guards the cellar. He hides in the northwest storeroom, ready to jump out and scare away anyone who heads for the stairs. Not eager to commit murder, Roscoe allows retreating characters to flee back to the sewers. He is a [wererat](https://www.dndbeyond.com/monsters/17055-wererat), with these changes:

*   Roscoe is Small and has 27 (6d6 + 6) hit points.
*   He has these racial traits: He can move through the space of a Medium or larger creature. He has advantage on saving throws against being [frightened](https://www.dndbeyond.com/sources/dnd/free-rules/rules-glossary#FrightenedCondition). He speaks Common and Halfling, and he knows thieves’ cant.
...
Volo knows the best places to eat and find merriment. He can also give characters a tour of Waterdeep. If the characters accept his offer, share the information in chapter 9, “[Volo’s Waterdeep Enchiridion](./09.Volos-Waterdeep-Enchiridion.md#volos-waterdeep-enchiridion),” with the players.

Although Renaer is estranged from his rich and powerful father, he still has friends in high places, including Harpers who can come to the characters’ rescue if they need it. If the characters are looking for an audience with influential persons in Waterdeep, Renaer can set up meetings with [Mirt](./Monsters-and-NPCs.md#mirt), [Remallia Haventree](./Monsters-and-NPCs.md#remallia-haventree) (see [appendix B](./Monsters-and-NPCs.md#appendix-b-monsters-and-npcs) for both), or just about any other Waterdavian noble, if he thinks the characters will comport themselves well.
